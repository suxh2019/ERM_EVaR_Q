...
# the optimal policy is for Figure 2 and figure 3
# EVaR risk level α = 0.6
...
for β in B
    ...
    lr = Counter(1e-10,harmonicDecay,decay_rate=1e-4,ϵ = 0.01)
    sa_method = "erm"
...
println("EVaR risk level α =0.6, the optimal policy on CW is : ", optimal_policy)
